...
# Advanced SQL Practice — Senior+ Tier

Senior-level / staff-tier SQL drill — aimed at quant (Two Sigma, Citadel, Jane Street), FAANG senior data-eng, and fintech (Stripe, Block, Plaid) screens. **65 problems** sourced from LeetCode SQL Hard (the ~15 not in v1), DataLemur, StrataScratch, Joe Celko's *SQL Puzzles*, TPC-H, and real interview writeups. All solutions in **Postgres 17/18** — uses `MERGE`, `JSON_TABLE`, `tablefunc.crosstab`, `PERCENTILE_CONT`, `LATERAL`, `DISTINCT ON`, `FILTER`, `EXCLUDE` constraints freely (no portable fallbacks).

Problems are organised by primary advanced pattern. Within each section, problems progress from "core mechanic" to "multi-pattern combination".

*Prompts are paraphrased for educational use. Solutions written for senior-interview Postgres prep, not as platform submissions.*
...
### 1. Cumulative Salary of an Employee
...
### 2. Longest Winning Streak Per Player
...
### 3. Trailing 7-Day Active User Average
...
### 4. Median Salary Per Department Excluding Self
...
### 5. Stock Price High-Water Mark and Drawdown
...
### 6. NTILE Decile Bucketing with Tie Stability
...
### 7. EXCLUDE CURRENT ROW for Peer-Comparison Z-Score
...
### 8. Time-Weighted Average Price (VWAP) by Bar
...
### 9. Hopper Company Active Driver-Days
...
### 10. Transitive Closure of Mutual Friend Suggestions
...
### 11. Hopper Subtask Dependency Resolution
...
### 12. Shortest Path in a Directed Weighted Graph
...
### 13. Reporting Chain with Levels
...
### 14. Bill of Materials Total Cost
...
### 16. Sessionize Page Views with 30-Minute Inactivity Gap
...
### 17. Consecutive Increasing Transactions Per User
...
### 19. Merge Overlapping Time Intervals
...
### 21. Weekly Cohort Retention Matrix
...
### 23. Churn Definition: 28-Day No-Activity
...
### 25. Cohort A/B Test Lift With Significance Tag
...
### 26. Point-In-Time Customer State (As-Of Join)
...
### 27. Last-Observation-Carried-Forward (LOCF) Time Series
...
### 28. Find Overlapping Reservations (Range Conflict)
...
### 29. Continuous Coverage with EXCLUDE Constraint
...
### 30. Bitemporal History Reconstruction
...
### 31. Sales Cube by Region, Product, and Quarter
...
### 32. Dynamic Pivot of Monthly Revenue
...
### 33. Dynamic Unpivot of Wide Table
...
### 34. ROLLUP with Visible Subtotal Labels
...
### 35. Customers Who Never Ordered Product X
...
### 36. Symmetric Difference of Two Sets
...
### 37. Anti-Join: Inactive Sellers (No Sale in 90 Days)
...
### 38. Intersection With Multiplicity
...
### 39. Semi-Join Via LATERAL EXISTS
...
### 40. Percentile Bands of Order Value
...
### 41. Linear Regression Slope and Intercept
...
### 42. Pearson Correlation Between Pairs of Series
...
### 43. Outlier Detection via Interquartile Range
...
### 44. Histogram Bucketing with WIDTH_BUCKET
...
### 45. Top Three Wineries per Country
...
### 46. Top-K with Deterministic Tie-Breaker
...
### 47. Greatest-N-Per-Group via DISTINCT ON
...
### 48. Median Within Group via Window-Free Aggregate
...
### 49. JSONB Path Extraction with Aggregation
...
### 50. JSON_TABLE for Tabular Projection of JSON
...
### 51. MERGE for Idempotent Upsert
...
### 52. Array Aggregation and Set Membership
...
### 53. Generate Series for Calendar Spine
...
### 54. Full-Text Search With Ranking
...
### 55. Convert IN-Subquery to Semi-Join Plan
...
### 56. Index for Range + Equality Lookup
...
### 57. Partial Index for Skewed Predicate
...
### 58. CTE Materialization Boundary
...
### 59. Covering Index With INCLUDE
...
### 60. Real-Time Fraud Ring Detection (Connected Components)
...
### 61. FX Triangular Arbitrage Detection
...
### 62. TPC-H Pricing Summary Report (Q1 Adapted)
...
### 63. TPC-H Local Supplier Volume (Q5 Adapted)
...
### 64. TPC-H Returned Item Reporting (Q10 Adapted)
...
### 65. Idempotent Daily Aggregate Refresh (Materialized View Strategy)
