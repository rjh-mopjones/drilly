...
export const MESSAGE_QUEUE: Diagram = {
  ...
  nodes: [
    // ---------------------------------------------------------------- producer
    {
      id: "producer",
      label: "Producer",
      sub: "in-process client: payments, CDC, clickstream",
      kind: "serviceGroup",
      col: 0,
      row: 1,
      detail: {
    ...
    },
    {
      id: "sender",
      label: "Sender",
      sub: "acks=all, enable.idempotence=true",
      kind: "process",
      col: 0,
      row: 4,
      parent: "producer",
    ...
    // ------------------------------------------------------------ control plane
    {
      ...
      sub: "3-5 nodes, brokers tail the metadata log",
      kind: "database",
      col: 1,
      row: 0,
      detail: {
    ...
    },
    {
      id: "broker",
      label: "Leader broker",
      sub: "the one appender for this partition",
      kind: "serviceGroup",
      col: 1,
      row: 3,
      parent: "rack",
    ...
    },
    {
      id: "append",
      label: "Log append",
      sub: "assigns offset N, updates sparse index",
      kind: "process",
      col: 1,
      row: 3,
      parent: "broker",
    ...
    },
    {
      ...
      sub: "min log-end-offset across the ISR",
      kind: "process",
      col: 1,
      row: 5,
      parent: "broker",
    ...
    },
    {
      id: "fetchsvc",
      label: "Fetch handler",
      sub: "sendfile; one path for followers and consumers",
      kind: "process",
      col: 1,
      row: 6,
      parent: "broker",
    ...
    },
    {
      ...
      sub: "12h local, closed segments to the bucket",
      kind: "process",
      col: 1,
      row: 7,
      parent: "broker",
    ...
    },
    {
      id: "pagecache",
      label: "OS page cache",
      sub: "kernel buffer over the segment files",
      kind: "cache",
      col: 2,
      row: 5,
      parent: "rack",
    ...
    // ---------------------------------------------------------- outside the cluster
    {
      ...
      sub: "closed segments, ~10x cheaper per byte",
      kind: "blob",
      col: 3,
      row: 7,
      detail: {
...

    {
      ...
      sub: "each partition to exactly one member",
      kind: "serviceGroup",
      col: 0,
      row: 8,
      detail: {
