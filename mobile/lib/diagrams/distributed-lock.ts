...
export const DISTRIBUTED_LOCK: Diagram = {
  ...
  nodes: [
    ...
    },
    {
      ...
      sub: "correctness or best effort, per call site",
      kind: "service",
      col: 0,
      row: 1,
      detail: {
    ...
    },
    {
      ...
      sub: "TTL 30s, renew at 10s with jitter",
      kind: "service",
      col: 1,
      row: 2,
      parent: "grant-side",
    ...
    },
    {
      ...
      sub: "AND fence_token < :token, one statement",
      kind: "service",
      col: 0,
      row: 4,
      detail: {
    ...
    },
    {
      ...
      sub: "version column CAS, no lock at all",
      kind: "service",
      col: 1,
      row: 4,
      detail: {
