  ...
  nodes: [
    {
      ...
      detail: {
        what: "Three jobs that run forever: repair rebuilds fragments after a drive dies, scrub re-reads all 21EB on a 90-day cadence to catch silent bit rot, and garbage collection sweeps pieces orphaned by aborted uploads and overwritten manifests.",
        ...
        numbers: [
          "repair: ~29 drives/day, ~6.7GB/s, 0.004% of fleet bandwidth",
          "scrub: 21EB / 90 days, ~2.7TB/s, 1.7% of aggregate read bandwidth",
          "gc: 7-day grace before a piece is swept",
        ],
        breaks:
