...
const COACHING = [/\binterview/i, /\bcandidates?\b/i, /\bsay (it|this|that|so) out loud/i, /\bout loud\b/i, /\bdrawn (as|here|dashed|bold)\b/i, /\bin the diagram\b/i, /\bthis diagram\b/i, /\bthe picture\b/i, /\bworth (saying|stating)\b/i, /\btime budget\b/i];
