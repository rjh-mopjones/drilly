 ...
 *
 *   bun run scripts/parse-check.ts
 *   bun run scripts/parse-check.ts --write   # re-baseline after an intended change
 *
...
const SOURCE_ID = "patterns";
const SNAPSHOT = join(ROOT, "scripts", "sd-parse-snapshot.json");
