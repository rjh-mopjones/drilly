...
for f in service-worker.js manifest.json patterns.md operating-systems-interview-primer.md concurrency-interview-primer.md api-design-interview-primer.md neetcode-150.md java-interview-primer.md go-interview-primer.md rust-interview-primer.md python-interview-primer.md kotlin-interview-primer.md cpp-interview-primer.md postgres-interview-primer.md db-theory-primer.md sql-patterns-primer.md sql-questions.md cassandra-interview-primer.md redis-interview-primer.md yugabyte-interview-primer.md csharp-interview-primer.md aws-interview-primer.md gcp-interview-primer.md linux-interview-primer.md kubernetes-interview-primer.md observability-interview-primer.md terraform-interview-primer.md docker-interview-primer.md cicd-interview-primer.md networking-interview-primer.md git-interview-primer.md ai-engineering-primer.md sql-postgres-cheatsheet.html cassandra-cheatsheet.html redis-cheatsheet.html yugabyte-cheatsheet.html java-cheatsheet.html csharp-cheatsheet.html go-cheatsheet.html cpp-cheatsheet.html aws-cheatsheet.html gcp-cheatsheet.html linux-cheatsheet.html kubernetes-cheatsheet.html observability-cheatsheet.html terraform-cheatsheet.html docker-cheatsheet.html cicd-cheatsheet.html networking-cheatsheet.html git-cheatsheet.html system-design-cheatsheet.html finance-domain-cheatsheet.html operating-systems-cheatsheet.html concurrency-cheatsheet.html api-design-cheatsheet.html system-design-patterns-primer.md dsa-patterns-primer.md; do
